	...
	render() {
		return (
			<div className={styles.container}>
				<Head>
					<title><a href="https://hci-science-project.github.io/Website/">HCI Science Discord Bot</a></title>
				...
				<main className={styles.main}>
					...
					<div className={styles.grid}>
						...
						<a href='https://hci-science-project.github.io/Teacher-Portal/' className={styles.card}>
							<h2>Teacher{String.fromCharCode(39)}s Portal</h2>
							<p>Login to the Teacher{String.fromCharCode(39)}s Portal (Teachers only)</p>
						</a>
