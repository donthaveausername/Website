...
<Container text>
  <main className={styles['top-padded']}>
    ...
    HCI Science Discord Bot is a feature-packed bot that helps you revise for science! Featuring interactive commands that can define, look up, and explain various difficult to  understand science terms, it will surely streamline your studying process!
    ## Features include:
